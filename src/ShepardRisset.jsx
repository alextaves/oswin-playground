...
// A slow, deep drone — layered detuned sine waves with gentle LFO movement
const VOICES = [
  { freq: 55,    detune:  0   },  // A1
  { freq: 55,    detune:  8   },  // slightly detuned — creates slow beating
  { freq: 110,   detune: -5   },  // A2
  { freq: 82.5,  detune:  3   },  // E2 — open fifth
  { freq: 27.5,  detune:  0   },  // A0 — sub
]

export default function Drone({ playing }) {
