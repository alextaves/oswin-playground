  ...
  return (
    <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -1.5, -18]}>
      ...
      <MeshReflectorMaterial
        color="#d5d6d8" roughness={0.1} metalness={0.0} mirror={0.9}
        blur={[400, 100]} resolution={1024} mixBlur={6} mixStrength={1.5}
...
export default function Cubes() {
  ...
  useEffect(() => {
    ...
    const handleTouchMove = (e) => {
      ...
      scrollRef.current = THREE.MathUtils.clamp(scrollRef.current - delta * 0.03, -50, 4)
    }
